...
############################################################
from util import load_true_csv
############################################################
class Config():
...
def main():
    ...
    parser.add_argument('--normalize', type=str, default="Z",
                        help='normalize type')
    ############################################################
    parser.add_argument('--true_csv', type=str, help="true.csv", default=None)
    ############################################################
    ...
    if args.true_csv is not None:
        test['y'] = load_true_csv(args.true_csv)
        test_accuracy = model.accuracy(test['y_'], test['y'])
